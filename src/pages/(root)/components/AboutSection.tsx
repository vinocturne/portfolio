...
export default function AboutSection() {
  return (
    <section
      id={'about'}
      className={
        'font-noto mx-auto max-w-[1140px] flex flex-col items-center justify-center py-16 gap-[60px]'
      }
    >
      <span className={'font-han text-5xl'}>About Me</span>
      <div
        className={
          'w-[100%] mw-auto flex flex-wrap flex-auto justify-center items-center gap-[42px]'
        }
      >
        <div
          className={
            'grow shrink md:w-[30%] sm:w-[50%] w-[100%] flex justify-start gap-[14px]'
          }
        >
